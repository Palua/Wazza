				  ...
				  <div class="boxes">
					<div class="row-fluid">
					  ...
					  <div class="span4">
						<div class="box">
						  <div class="icon">
							<img src="img/Products/Potions/Improvements/Protecto.png" class="" alt="" />
						  </div>
						  <h4 style="color:black;">Protecto</h4>
						  <h5 style="color:black;">8 Pièces d'or</h4>
						</div>
					  </div>
					  ...
					  <div class="span4">
						<div class="box">
						  <div class="icon">
							<img src="img/Products/Potions/Improvements/Robusto.png" class="" alt="" />
						  </div>
						  <h4 style="color:black;">Robusto</h4>
						  <h5 style="color:black;">9 Pièces d'or</h4>
						</div>
					  </div>
					  ...
					  <div class="span4">
						<div class="box">
						  <div class="icon">
							<img src="img/Products/Potions/Improvements/Tempo.png" class="" alt="" />
						  </div>
						  <h4 style="color:black;">Tempo</h4>
						  <h5 style="color:black;">6 Pièces d'or</h4>
						</div>
					  </div>
					</div>
				 </div>
				  ...
				  <div class="boxes">
					<div class="row-fluid">
					  ...
					  <div class="span4">
						<div class="box">
						  <div class="icon">
							<img src="img/Products/Potions/Healing/Potion.png" class="" alt="" />
						  </div>
						  <h4 style="color:black;">Potion</h4>
					  ...
					  <div class="span4">
						<div class="box">
						  <div class="icon">
							<img src="img/Products/Potions/Healing/SuperPotion.png" class="" alt="" />
						  </div>
						  <h4 style="color:black;">Super Potion</h4>
						  <h5 style="color:black;">4 Pièces d'or</h4>
						</div>
					  </div>
					  ...
					  <div class="span4">
						<div class="box">
						  <div class="icon">
							<img src="img/Products/Potions/Healing/hyperpotion.jpg" class="" alt="" />
						  </div>
						  <h4 style="color:black;">Hyper Potion</h4>
						  <h5 style="color:black;">6 Pièces d'or</h4>
